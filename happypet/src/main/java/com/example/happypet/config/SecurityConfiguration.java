        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("api/auth/register", "api/auth/authenticate",
                                ...
                                "api/v1/adduser",
                                "api/v1/updateuser", "api/v1/deleteuser/{userId}",
                                "api/v1/getowners","api/v1/addowner","api/v1/updateowner/{id}","api/v1/deleteowner/{ownerId}").permitAll() // Public endpoints
